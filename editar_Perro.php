<?php
    ...
    $sql="SELECT * FROM tab_perros WHERE ID_Perro='$ID_Perro'";
...
<!--Cargamos el header-->
    ...
    <div class="login">
        <h1>Actualizar Informacion del Perro</h1>
        <form name="editar_perro" action="editar_Perro_con.php" method="POST">
        <input type="hidden" name="ID_Perro" id="ID_Perro" value="<?= $row['ID_Perro']?>">
            <label for="Nombre">
            ...
            <input type="submit" name="editar_perro_btn"  id="editar_perro_btn" value="Actualizar informacion">
        </form>
