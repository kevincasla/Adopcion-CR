<?php
    ...
    $sql="SELECT * FROM tab_cuidado_perros WHERE ID_Cuidado_Perro='$ID_Cuidado_Perro'";
...
<!--Cargamos el header-->
    ...
    <div class="login">
        ...
        <form name="editar_cuidado" action="editar_Cuidado_Perros_con.php" method="POST">
        <input type="hidden" name="ID_Cuidado_Perro" id="ID_Cuidado_Perro" value="<?= $row['ID_Cuidado_Perro']?>">
        <label for="Titulo">
